...
export const featured: Project[] = [
  {
    ...
    repo: "https://github.com/Fors-Corp/marcfors.com",
  ...
  },
  {
    name: "LMaaS",
    blurb: {
      en: "Self-hosted model service on Apple Silicon: serves local language models over an OpenAI-compatible API, so my own apps call inference without a cloud provider, and trains, serves and retrains ML models behind SemVer releases. Go API, React console.",
      es: "Servicio de modelos autoalojado en Apple Silicon: sirve modelos de lenguaje locales con una API compatible con OpenAI, para que mis apps hagan inferencia sin proveedor cloud, y entrena, sirve y reentrena modelos de ML con releases SemVer. API en Go, consola en React.",
      ca: "Servei de models autoallotjat a Apple Silicon: serveix models de llenguatge locals amb una API compatible amb OpenAI, perquè les meves apps facin inferència sense proveïdor cloud, i entrena, serveix i reentrena models d'ML amb releases SemVer. API en Go, consola en React.",
      it: "Servizio di modelli self-hosted su Apple Silicon: serve modelli linguistici locali con un'API compatibile OpenAI, così le mie app fanno inferenza senza provider cloud, e allena, serve e riaddestra modelli ML con release SemVer. API Go, console React.",
      pt: "Serviço de modelos auto-alojado em Apple Silicon: serve modelos de linguagem locais com uma API compatível com OpenAI, para que as minhas apps façam inferência sem fornecedor cloud, e treina, serve e retreina modelos de ML com releases SemVer. API em Go, consola em React.",
      de: "Selbst gehosteter Modelldienst auf Apple Silicon: stellt lokale Sprachmodelle über eine OpenAI-kompatible API bereit, damit meine Apps ohne Cloud-Anbieter inferieren, und trainiert, serviert und retrainiert ML-Modelle hinter SemVer-Releases. Go-API, React-Konsole.",
    },
  ...
  },
  {
    name: "forsight",
    blurb: {
      en: "Observability platform, two versioned artifacts from one tree: a Go agent that collects metrics, serves an HTTP API and embeds its own dashboard, with ML anomaly scoring and forecasts; and the React component library it renders through.",
      es: "Plataforma de observabilidad, dos artefactos versionados desde un mismo árbol: un agente en Go que recoge métricas, sirve una API HTTP e incrusta su propio panel, con detección de anomalías y previsiones por ML; y la librería de componentes React con la que se pinta.",
      ca: "Plataforma d'observabilitat, dos artefactes versionats des d'un mateix arbre: un agent en Go que recull mètriques, serveix una API HTTP i incrusta el seu propi panell, amb detecció d'anomalies i previsions per ML; i la llibreria de components React amb què es pinta.",
      it: "Piattaforma di observability, due artefatti versionati da un unico albero: un agente Go che raccoglie metriche, serve un'API HTTP e incorpora la propria dashboard, con scoring delle anomalie e previsioni via ML; e la libreria di componenti React con cui si disegna.",
      pt: "Plataforma de observabilidade, dois artefactos versionados a partir da mesma árvore: um agente em Go que recolhe métricas, serve uma API HTTP e incorpora o seu próprio painel, com deteção de anomalias e previsões por ML; e a biblioteca de componentes React com que se desenha.",
      de: "Observability-Plattform, zwei versionierte Artefakte aus einem Baum: ein Go-Agent, der Metriken sammelt, eine HTTP-API bereitstellt und sein eigenes Dashboard einbettet, mit ML-Anomaliebewertung und Prognosen; und die React-Komponentenbibliothek, mit der er rendert.",
    },
    stack: ["Go", "TypeScript", "React"],
    repo: "https://github.com/Fors-Corp/forsight",
    live: "https://fors-corp.github.io/forsight/",
    spotlight: true,
  },
  {
    name: "Fors Design System",
    blurb: {
      en: "Brand tokens plus 30 Radix-backed React components behind every product I ship: dark/light theming, WCAG 2.1 AA, RTL, published to GitHub Packages.",
      es: "Tokens de marca y 30 componentes React sobre Radix detrás de todo lo que publico: tema claro/oscuro, WCAG 2.1 AA, RTL, publicado en GitHub Packages.",
      ca: "Tokens de marca i 30 components React sobre Radix darrere de tot el que publico: tema clar/fosc, WCAG 2.1 AA, RTL, publicat a GitHub Packages.",
      it: "Token di brand e 30 componenti React basati su Radix dietro ogni prodotto che rilascio: tema chiaro/scuro, WCAG 2.1 AA, RTL, pubblicato su GitHub Packages.",
      pt: "Tokens de marca e 30 componentes React sobre Radix por trás de tudo o que publico: tema claro/escuro, WCAG 2.1 AA, RTL, publicado no GitHub Packages.",
      de: "Markentokens plus 30 Radix-basierte React-Komponenten hinter jedem Produkt, das ich ausliefere: Hell/Dunkel-Theming, WCAG 2.1 AA, RTL, veröffentlicht auf GitHub Packages.",
    },
    stack: ["React", "TypeScript", "Radix UI"],
    repo: "https://github.com/Fors-Corp/fors-design-system",
    live: "https://fors-corp.github.io/fors-design-system/",
    spotlight: true,
  },
  {
    name: "GH Dashboard",
