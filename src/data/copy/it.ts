...
export const ui: UiCopy = {
  ...
  breakTitle: "Fors Corp · pratica indipendente",
  ...
  contactLede: "Due porte, una casella. Recruiter con un ruolo IA o frontend, o chi ha bisogno di un'app su misura. Lo leggo.",
  hireCta: "Assumimi",
  buildCta: "Commissiona un lavoro",
  writeCta: "Scrivimi",
  hirePath: "Recruiter",
  buildPath: "Lavoro su misura",
  hirePathLede: "Ruoli di ingegneria IA e LLM. Barcellona o remoto UE. Agenti, React, TypeScript, Go.",
  buildPathLede: "Prodotto, dashboard o tool interno? Lo porto dal design tecnico alla produzione.",
  hireSubject: `Ruolo IA — ${SITE_HOST}`,
  buildSubject: `App su misura — ${SITE_HOST}`,
  source: "Codice",
  sourceFor: "Codice sorgente di {project}",
  liveFor: "Sito live di {project}",
  caseStudyFor: "Caso di studio di {project}",
  live: "Live",
  private: "Privato",
  public: "Pubblico",
  lang: "Lingua",
  ...
  navLabel: "Principale",
  seeking: "IA · agenti LLM · Barcellona o remoto UE · disponibile ora",
  ...
  cvLede: "Il CV di una pagina, in PDF. Leggilo qui o portane una copia.",
  cvDownload: "Scarica il PDF",
  cvOpen: "Apri in una nuova scheda",
  cvUnsupported: "Non si vede? Aprilo in una nuova scheda o scarica il PDF.",
  ...
  hits: [
    ...
    "agenti LLM come team di consegna",
    "Claude Code, Codex, Cursor e Grok",
    "server MCP",
    "al modello giusto",
    "Ruoli di ingegneria IA e LLM",
    "Barcellona o remoto UE",
    "Recruiter con un ruolo IA o frontend",
  ],
  vitalGood: "Buono",
  vitalDefs: {
...
export const careerBreak: { when: string; body: string } = {
  ...
  body: "Costruisco prodotti completi con agenti LLM come team di consegna: design system, un agente di observability, un servizio di modelli che si riaddestra da solo. Aperto a ruoli di ingegneria IA e a lavoro su misura.",
};
